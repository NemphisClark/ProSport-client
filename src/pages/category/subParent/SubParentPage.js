...
import { getParentSub } from "../../../functions/subParent";
...
const SubParentHome = ({ match }) => {
  ...
  useEffect(() => {
    setLoading(true);
    getParentSub(slug).then((res) => {
      console.log(JSON.stringify(res.data, null, 4));
      setParentSub(res.data.subParent);
  ...
  const handleSeason = (e) => {
    ...
    setProductSize("");
    setProductStructure("");
    setProductSeason(e.target.value);
    setColor("");
    fetchProducts({ productSeason: e.target.value });
  };
  ...
  const handleStructure = (e) => {
    ...
    setBrand("");
    setProductSize("");
    setProductStructure(e.target.value);
    setProductSeason("");
    setColor("");
    fetchProducts({ productStructure: e.target.value });
  };
      ...
      <React.Fragment key={struct}>
        <div>
          <input
            ...
            value={struct}
            name={struct}
            checked={struct === productStructure}
      ...
      <div className="catalogue-wrapper">
        <div className="catalogue-menu">
          <div className="catalogue-menu__top">
            <div className="catalogue-menu__title">{parentSub.name}</div>
            ...
            <div className="catalogue-menu__sections">
              ...
              <div className="select-types" onClick={handleSeasonDropdown}>
                <div className="select__title" data-default="Сезон">
                  {productSeason ? productSeason : "Сезон"}
                </div>
              ...
              <div className="select-types" onClick={handleStructureDropdown}>
                <div className="select__title" data-default="Состав">
                  {productStructure ? productStructure : "Состав"}
                </div>
